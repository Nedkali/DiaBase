Module Module1
    ...
    Sub SearchRoutine()
        ...
        For Each ItemObjectItem As ItemObjects In Objects       'Sequentually reference through all Object entries (iterates entire database)
            ...
            SearchProgressForm.SearchProgressLABEL2.Text = "Checking " & count & " of " & Form1.AllItemsInDatabaseListBox.Items.Count & " Items"
            ...
            If UCase(Form1.SearchFieldCOMBOBOX.Text) = "UNIQUE ATTRIBUTES" Then
                ...
                If Form1.ExactMatchCHECKBOX.Checked = True Then
                    ...
                    If Form1.SearchOperatorCOMBOBOX.Text = "Equal To" Then
                        If (Form1.SearchWordCOMBOBOX.Text) = (ItemObjectItem.Stat1) And RefineSearchReferenceList.Contains(count) = True Then Form1.SearchLISTBOX.Items.Add(Objects(count).ItemName) : SearchReferenceList.Add(count) : GoTo ItemMatched '       EqualTo
                        If (Form1.SearchWordCOMBOBOX.Text) = (ItemObjectItem.Stat2) And RefineSearchReferenceList.Contains(count) = True Then Form1.SearchLISTBOX.Items.Add(Objects(count).ItemName) : SearchReferenceList.Add(count) : GoTo ItemMatched '       EqualTo
                        If (Form1.SearchWordCOMBOBOX.Text) = (ItemObjectItem.Stat3) And RefineSearchReferenceList.Contains(count) = True Then Form1.SearchLISTBOX.Items.Add(Objects(count).ItemName) : SearchReferenceList.Add(count) : GoTo ItemMatched '       EqualTo
                        If (Form1.SearchWordCOMBOBOX.Text) = (ItemObjectItem.Stat4) And RefineSearchReferenceList.Contains(count) = True Then Form1.SearchLISTBOX.Items.Add(Objects(count).ItemName) : SearchReferenceList.Add(count) : GoTo ItemMatched '       EqualTo
                        If (Form1.SearchWordCOMBOBOX.Text) = (ItemObjectItem.Stat5) And RefineSearchReferenceList.Contains(count) = True Then Form1.SearchLISTBOX.Items.Add(Objects(count).ItemName) : SearchReferenceList.Add(count) : GoTo ItemMatched '       EqualTo
                        If (Form1.SearchWordCOMBOBOX.Text) = (ItemObjectItem.Stat6) And RefineSearchReferenceList.Contains(count) = True Then Form1.SearchLISTBOX.Items.Add(Objects(count).ItemName) : SearchReferenceList.Add(count) : GoTo ItemMatched '       EqualTo
                        If (Form1.SearchWordCOMBOBOX.Text) = (ItemObjectItem.Stat7) And RefineSearchReferenceList.Contains(count) = True Then Form1.SearchLISTBOX.Items.Add(Objects(count).ItemName) : SearchReferenceList.Add(count) : GoTo ItemMatched '       EqualTo
                        If (Form1.SearchWordCOMBOBOX.Text) = (ItemObjectItem.Stat8) And RefineSearchReferenceList.Contains(count) = True Then Form1.SearchLISTBOX.Items.Add(Objects(count).ItemName) : SearchReferenceList.Add(count) : GoTo ItemMatched '       EqualTo
                        If (Form1.SearchWordCOMBOBOX.Text) = (ItemObjectItem.Stat9) And RefineSearchReferenceList.Contains(count) = True Then Form1.SearchLISTBOX.Items.Add(Objects(count).ItemName) : SearchReferenceList.Add(count) : GoTo ItemMatched '       EqualTo
                        If (Form1.SearchWordCOMBOBOX.Text) = (ItemObjectItem.Stat10) And RefineSearchReferenceList.Contains(count) = True Then Form1.SearchLISTBOX.Items.Add(Objects(count).ItemName) : SearchReferenceList.Add(count) : GoTo ItemMatched '       EqualTo
                        If (Form1.SearchWordCOMBOBOX.Text) = (ItemObjectItem.Stat11) And RefineSearchReferenceList.Contains(count) = True Then Form1.SearchLISTBOX.Items.Add(Objects(count).ItemName) : SearchReferenceList.Add(count) : GoTo ItemMatched '       EqualTo
                        If (Form1.SearchWordCOMBOBOX.Text) = (ItemObjectItem.Stat12) And RefineSearchReferenceList.Contains(count) = True Then Form1.SearchLISTBOX.Items.Add(Objects(count).ItemName) : SearchReferenceList.Add(count) : GoTo ItemMatched '       EqualTo
                        If (Form1.SearchWordCOMBOBOX.Text) = (ItemObjectItem.Stat13) And RefineSearchReferenceList.Contains(count) = True Then Form1.SearchLISTBOX.Items.Add(Objects(count).ItemName) : SearchReferenceList.Add(count) : GoTo ItemMatched '       EqualTo
                        If (Form1.SearchWordCOMBOBOX.Text) = (ItemObjectItem.Stat14) And RefineSearchReferenceList.Contains(count) = True Then Form1.SearchLISTBOX.Items.Add(Objects(count).ItemName) : SearchReferenceList.Add(count) : GoTo ItemMatched '       EqualTo
                        If (Form1.SearchWordCOMBOBOX.Text) = (ItemObjectItem.Stat15) And RefineSearchReferenceList.Contains(count) = True Then Form1.SearchLISTBOX.Items.Add(Objects(count).ItemName) : SearchReferenceList.Add(count) : GoTo ItemMatched '       EqualTo
                    ...
                    If Form1.SearchOperatorCOMBOBOX.Text = "Not Equal To" Then
                        If (Form1.SearchWordCOMBOBOX.Text) <> (ItemObjectItem.Stat1) And RefineSearchReferenceList.Contains(count) = True Then Form1.SearchLISTBOX.Items.Add(Objects(count).ItemName) : SearchReferenceList.Add(count) : GoTo ItemMatched '  NotEqualTo 
                        If (Form1.SearchWordCOMBOBOX.Text) <> (ItemObjectItem.Stat2) And RefineSearchReferenceList.Contains(count) = True Then Form1.SearchLISTBOX.Items.Add(Objects(count).ItemName) : SearchReferenceList.Add(count) : GoTo ItemMatched '  NotEqualTo 
                        If (Form1.SearchWordCOMBOBOX.Text) <> (ItemObjectItem.Stat3) And RefineSearchReferenceList.Contains(count) = True Then Form1.SearchLISTBOX.Items.Add(Objects(count).ItemName) : SearchReferenceList.Add(count) : GoTo ItemMatched '  NotEqualTo 
                        If (Form1.SearchWordCOMBOBOX.Text) <> (ItemObjectItem.Stat4) And RefineSearchReferenceList.Contains(count) = True Then Form1.SearchLISTBOX.Items.Add(Objects(count).ItemName) : SearchReferenceList.Add(count) : GoTo ItemMatched '  NotEqualTo 
                        If (Form1.SearchWordCOMBOBOX.Text) <> (ItemObjectItem.Stat5) And RefineSearchReferenceList.Contains(count) = True Then Form1.SearchLISTBOX.Items.Add(Objects(count).ItemName) : SearchReferenceList.Add(count) : GoTo ItemMatched '  NotEqualTo 
                        If (Form1.SearchWordCOMBOBOX.Text) <> (ItemObjectItem.Stat6) And RefineSearchReferenceList.Contains(count) = True Then Form1.SearchLISTBOX.Items.Add(Objects(count).ItemName) : SearchReferenceList.Add(count) : GoTo ItemMatched '  NotEqualTo 
                        If (Form1.SearchWordCOMBOBOX.Text) <> (ItemObjectItem.Stat7) And RefineSearchReferenceList.Contains(count) = True Then Form1.SearchLISTBOX.Items.Add(Objects(count).ItemName) : SearchReferenceList.Add(count) : GoTo ItemMatched '  NotEqualTo 
                        If (Form1.SearchWordCOMBOBOX.Text) <> (ItemObjectItem.Stat8) And RefineSearchReferenceList.Contains(count) = True Then Form1.SearchLISTBOX.Items.Add(Objects(count).ItemName) : SearchReferenceList.Add(count) : GoTo ItemMatched '  NotEqualTo 
                        If (Form1.SearchWordCOMBOBOX.Text) <> (ItemObjectItem.Stat9) And RefineSearchReferenceList.Contains(count) = True Then Form1.SearchLISTBOX.Items.Add(Objects(count).ItemName) : SearchReferenceList.Add(count) : GoTo ItemMatched '  NotEqualTo 
                        If (Form1.SearchWordCOMBOBOX.Text) <> (ItemObjectItem.Stat10) And RefineSearchReferenceList.Contains(count) = True Then Form1.SearchLISTBOX.Items.Add(Objects(count).ItemName) : SearchReferenceList.Add(count) : GoTo ItemMatched '  NotEqualTo 
                        If (Form1.SearchWordCOMBOBOX.Text) <> (ItemObjectItem.Stat11) And RefineSearchReferenceList.Contains(count) = True Then Form1.SearchLISTBOX.Items.Add(Objects(count).ItemName) : SearchReferenceList.Add(count) : GoTo ItemMatched '  NotEqualTo 
                        If (Form1.SearchWordCOMBOBOX.Text) <> (ItemObjectItem.Stat12) And RefineSearchReferenceList.Contains(count) = True Then Form1.SearchLISTBOX.Items.Add(Objects(count).ItemName) : SearchReferenceList.Add(count) : GoTo ItemMatched '  NotEqualTo 
                        If (Form1.SearchWordCOMBOBOX.Text) <> (ItemObjectItem.Stat13) And RefineSearchReferenceList.Contains(count) = True Then Form1.SearchLISTBOX.Items.Add(Objects(count).ItemName) : SearchReferenceList.Add(count) : GoTo ItemMatched '  NotEqualTo 
                        If (Form1.SearchWordCOMBOBOX.Text) <> (ItemObjectItem.Stat14) And RefineSearchReferenceList.Contains(count) = True Then Form1.SearchLISTBOX.Items.Add(Objects(count).ItemName) : SearchReferenceList.Add(count) : GoTo ItemMatched '  NotEqualTo 
                        If (Form1.SearchWordCOMBOBOX.Text) <> (ItemObjectItem.Stat15) And RefineSearchReferenceList.Contains(count) = True Then Form1.SearchLISTBOX.Items.Add(Objects(count).ItemName) : SearchReferenceList.Add(count) : GoTo ItemMatched '  NotEqualTo 
